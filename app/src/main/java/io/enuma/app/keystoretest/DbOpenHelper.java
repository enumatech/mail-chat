...
//                    "messageid TEXT PRIMARY KEY COLLATE NOCASE, " +
//                    "message TEXT, " +
//                    "messageid TEXT KEY );";
...
//        db.execSQL(MESSAGES_TABLE_CREATE);
    ...
    public void readAll() {
        Cursor cursor = getReadableDatabase().query(CONTACTS_TABLE_NAME, new String[] {"email","name","pubkeyhash"}, null, null, null, null, null);
